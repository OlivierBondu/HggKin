...
chi2list_bkg3=""
    ...
    echo "\\end{tabular}"
    echo "\\begin{minipage}{0.33\\linewidth}"
    echo "\\includegraphics[width=6cm]{/afs/cern.ch/work/c/cgoudet/private/plot/pdf/fit_gghtsallispol2_cuttheta${cut}.pdf}"
    echo "\\end{minipage}"
    echo "\\begin{minipage}{0.33\\linewidth}"
    echo "\\includegraphics[width=6cm]{/afs/cern.ch/work/c/cgoudet/private/plot/pdf/fit_vbftsallispol1_cuttheta${cut}.pdf}"
    echo "\\end{minipage}"
    echo "\\begin{minipage}{0.33\\linewidth}"
    echo "\\includegraphics[width=6cm]{/afs/cern.ch/work/c/cgoudet/private/plot/pdf/fit_bkgtsallispol2_cuttheta${cut}.pdf}"
    echo "\\end{minipage}"
