...
//   canvas->Close();
  ...
  SPlot *splot_gghbkg=new SPlot("splot_gghbkg","splot_gghbkg", *sim_gghbkg, model_gghbkg, RooArgList(*ggh_yield, *bkg_yield));  //Create splot
  ws->import(*sim_gghbkg,Rename("simW_gghbkg"));
